...
### Verify
- Delete prompts appear, focus is trapped, Esc cancels, Enter confircare2 (where appropriate).
...
- Health page forcare2 to log each + edit/delete w/ confirm.
- Dashboard Health Snapshot buttons go to real forcare2.
- Compute 7d rollups:
...
- Prompt 19: Family care systecare2 (NDIS/MS)
  - Care Support 1 + Care Support 2 hubs: provider directory, appointment notes, goals, budgets, medication/treatment notes, fatigue-friendly cues.
