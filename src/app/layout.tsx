      ...
      >
        ...
        <div className="min-h-screen">
          <header className="border-b border-neutral-200 bg-white/80 backdrop-blur">
            <div className="mx-auto flex max-w-6xl flex-wrap itecare2-center justify-between gap-3 px-4 py-4">
              ...
              <nav className="flex flex-wrap itecare2-center gap-4 text-sm">
