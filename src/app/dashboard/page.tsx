  ...
  return (
    <div className="space-y-8">
      <section className="rounded-xl border border-neutral-200 bg-gradient-to-r from-white via-neutral-50 to-white px-6 py-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:itecare2-center md:justify-between">
          <div>
          ...
          <CardContent className="grid gap-3 sm:grid-cols-2">
            {quickLaunch.map((item) => (
              <a
                ...
                className="group flex itecare2-center justify-between rounded-lg border border-neutral-200 bg-white px-3 py-3 transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2"
              >
                <div>
          ...
          <CardContent className="space-y-3">
            {broken.length === 0 ? (
              ...
              broken.map((item) => (
                <div
                  key={item.id}
                  className="flex itecare2-center justify-between rounded-md border border-red-100 bg-red-50 px-3 py-2"
                >
                  <div>
                    <a
                      href={item.primaryUrl}
            ...
            {pinnedAreas.length === 0 ? (
              ...
              pinnedAreas.map((area) => (
                <Link
                  key={area.slug}
                  href={`/life/${area.slug}`}
                  className="flex itecare2-center justify-between rounded-md border border-neutral-200 bg-white px-3 py-2 hover:bg-neutral-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2"
                >
                  <div>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-2">
            {recent.length === 0 ? (
              <p className="text-sm text-neutral-600">No recently opened itecare2.</p>
            ) : (
              recent.map((item) => (
                <div
                  key={item.id}
