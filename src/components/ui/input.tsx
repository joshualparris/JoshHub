  ...
  return (
    <input
      className={cn(
        ...
        "dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-100 dark:ring-offset-slate-900 dark:placeholder:text-slate-500 dark:focus-visible:ring-slate-400",
