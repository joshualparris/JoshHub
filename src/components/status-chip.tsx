...
const statusColors: Record<AppStatus, { label: string; className: string }> = {
  ...
  archived: {
    label: "Archived",
    className: "bg-neutral-200 text-neutral-800 dark:bg-slate-800 dark:text-slate-100",
  },
  active: {
    label: "Active",
    className: "bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-100",
  },
  maintained: {
    label: "Maintained",
    className: "bg-cyan-100 text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-100",
  },
  paused: {
    label: "Paused",
    className: "bg-orange-100 text-orange-800 dark:bg-orange-900/40 dark:text-orange-100",
  },
  complete: {
    label: "Complete",
    className: "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-100",
  },
  "archive-candidate": {
  ...
  unknown: {
    label: "Unknown",
    className: "bg-neutral-100 text-neutral-800 dark:bg-slate-800 dark:text-slate-300",
  },
};
