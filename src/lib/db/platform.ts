...
export async function createOpportunity(input: Partial<PlatformOpportunity> & { name: string }) {
  const record: PlatformOpportunity = {
    ...
    expectedValuePerMonth: input.expectedValuePerMonth ?? null ?? undefined,
    probability: input.probability ?? null ?? undefined,
    stressScore: input.stressScore ?? null ?? undefined,
    notes: input.notes ?? null ?? undefined,
    tags: input.tags ?? [],
    createdAt: nowIso(),
    updatedAt: nowIso(),
  };
...
export async function createDecision(input: Partial<PlatformDecisionCard> & { question: string }) {
  const record: PlatformDecisionCard = {
    ...
    dueBy: input.dueBy ?? null ?? undefined,
    decision: input.decision ?? null ?? undefined,
    context: input.context ?? null ?? undefined,
    tags: input.tags ?? [],
    createdAt: nowIso(),
    updatedAt: nowIso(),
  };
...
export async function createMoveOpsTask(input: Partial<PlatformMoveOp> & { title: string }) {
  const record: PlatformMoveOp = {
    ...
    dueDate: input.dueDate ?? null ?? undefined,
    notes: input.notes ?? null ?? undefined,
    tags: input.tags ?? [],
    sortOrder: input.sortOrder ?? null ?? undefined,
    createdAt: nowIso(),
    updatedAt: nowIso(),
  };
