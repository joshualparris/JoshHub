...
export type MetadataConfidence = "verified" | "inferred" | "needs-review";

export type AppCategory = "Dubbo / DCS" | "Games" | string;

export type AppLinkType = "live" | "repo" | "docs" | "alternate";
...
export type AppAvailability = "web" | "local" | "hybrid" | "unknown";
...
export const apps: CatalogItem[] = [
  ...
  },
  {
    ...
    urls: [
      ...
      { label: "Live", url: "https://REDACTED_USER-stack.github.io/OrgScape/" },
    ],
  },
  {
    id: "null-itch",
  ...
  },
  {
    ...
    primaryUrl: "https://REDACTED_USER-stack.github.io/Null/",
    urls: [{ label: "Play (GH)", url: "https://REDACTED_USER-stack.github.io/Null/" }],
    notes: "v2 local build is currently unavailable; falls back to the live GH build.",
  ...
  },
  {
    ...
    urls: [
      { label: "Download/Info", url: "/docs/lexicon.html" },
  ...
  },
  {
    ...
    notes:
      "The previously catalogued local Three.js build is not present in this repository. No playable build is currently registered.",
  ...
  },
  {
    ...
    urls: [{ label: "Unavailable", url: "/archive" }],
    notes:
      "The previously catalogued local Twine export is not present in this repository. No playable build is currently registered.",
  ...
  },
  {
    ...
    urls: [
      ...
      { label: "Repo", url: "https://github.com/parristechservices1-beep/campaign-copilot" },
    ],
    notes: "Full Campaign Copilot UI for the Spider Queen campaign.",
    nextAction: "Expand campaign content and encounters.",
    lastTouched: "2025-12",
  },
  {
    id: "energy-quest",
  ...
  },
  {
    ...
    tags: ["game", "buckland", "blocks", "browser", "playable"],
    primaryUrl: "/games/buckland-blocks/index.html",
    urls: [{ label: "Play (Local)", url: "/games/buckland-blocks/index.html" }],
  ...
  },
  {
    ...
    primaryUrl: "https://josh-hub-two.vercel.app/dashboard",
    urls: [
      { label: "Dashboard", url: "https://josh-hub-two.vercel.app/dashboard" },
  ...
  },
  {
    ...
    primaryUrl: "https://parris-budget-app.vercel.app/",
    urls: [
      { label: "Live", url: "https://parris-budget-app.vercel.app/" },
  ...
  },
  {
    ...
    urls: [{ label: "Play", url: "/games/boundary-road/index.html" }],
    notes:
  ...
  {
    id: "sylvie-care1-directory",
    name: "Care Support 1 OT + Speech Directory",
    type: "app",
    category: "Planning",
    status: "ok",
  ...
  },
  {
    ...
    urls: [{ label: "Unavailable", url: "/archive" }],
    notes:
      "The previously catalogued local Christmas rotation page is not present in this repository. No live build is currently registered.",
  ...
  },
  {
    ...
    urls: [
      ...
      { label: "Download/Info", url: "/docs/lexicon-journal.html" },
    ],
  ...
  },
  {
    ...
    notes:
      "The local static build is absent; the registered workspace route is the canonical destination.",
    lastTouched: "2026-02",
    availability: "unknown",
    metadataConfidence: "verified",
  },
  ...
  {
    id: "neverwinter-game",
    name: "Neverwinter Game",
    type: "game",
    category: "Games",
    status: "ok",
    tags: ["game", "neverwinter", "workspace", "local"],
  ...
  {
    id: "neverwinter-game-fixed",
    name: "Neverwinter Game (Fixed)",
    type: "game",
    category: "Games",
    status: "ok",
  ...
  },
  {
    ...
    urls: [{ label: "Unavailable", url: "/archive" }],
    notes:
      "The previously catalogued local OurDCS status page is not present in this repository. No live workspace destination is currently registered.",
    lastTouched: "2026-02",
    availability: "unknown",
    metadataConfidence: "verified",
  },
  {
    id: "starhaven-mystery",
    name: "Starhaven Mystery",
    type: "game",
    category: "Games",
    status: "ok",
  ...
  {
    id: "whispering-wilds-docs",
    name: "Whispering Wilds Docs",
    type: "app",
    category: "Writing & Content",
    status: "ok",
  ...
  {
    id: "serenity-keep-flying",
    name: "Serenity: Keep Flying",
    type: "game",
    category: "Games",
    status: "broken",
    ...
    urls: [{ label: "Unavailable", url: "/archive" }],
    notes:
      "The previously catalogued local browser build is not present in this repository. No playable build is currently registered.",
    lastTouched: "2026-02",
    availability: "unknown",
    metadataConfidence: "verified",
  },
  ...
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["python", "gmail", "gui", "utility"],
    primaryUrl: "",
    urls: [],
    localPath: "C:/EmailCheck",
    notes: "Python-based Gmail search GUI with Thunderbird autoconfig support.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "local",
  },
  {
    id: "avance-work-companion",
    name: "Avance Work Companion",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["avance", "professional-development", "utility"],
    primaryUrl: "",
    urls: [],
    localPath: "C:/AvanceProfessionalDevelopment/AvanceWorkCompanion",
    notes: "Part of the Avance Professional Development suite.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "local",
  },
  ...
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["go", "cursor", "utility"],
    primaryUrl: "",
    urls: [],
    localPath: "C:/cursorrr",
    notes: "Help utility for Cursor/Go development.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "local",
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["vite", "react", "elias"],
    primaryUrl: "https://elias-app2.vercel.app/",
    liveUrl: "https://elias-app2.vercel.app/",
    urls: [{ label: "Live", url: "https://elias-app2.vercel.app/", type: "live" }],
    localPath: "C:/EliasApp",
    notes: "Vite-based React application.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "hybrid",
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["nextjs", "typescript", "app-factory"],
    primaryUrl: "https://appfactory-inky.vercel.app/",
  ...
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["health", "tracking", "healthlens", "rust"],
    primaryUrl: "https://health-lens-rust.vercel.app/",
    liveUrl: "https://health-lens-rust.vercel.app/",
    repoUrl: "https://github.com/joshualparris/HealthLens",
    urls: [
      { label: "Live", url: "https://health-lens-rust.vercel.app/", type: "live" },
      { label: "Repo", url: "https://github.com/joshualparris/HealthLens", type: "repo" },
    ],
    localPath: "C:/JoshHealth/HealthLens",
    notes: "Health tracking and analysis application.",
    lastTouched: "2026-05",
    metadataConfidence: "verified",
    availability: "hybrid",
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["health", "tracking", "cyan"],
    primaryUrl: "https://josh-health-cyan.vercel.app/",
    liveUrl: "https://josh-health-cyan.vercel.app/",
    repoUrl: "https://github.com/joshuaparris-max/JoshHealth",
    urls: [
      { label: "Live", url: "https://josh-health-cyan.vercel.app/", type: "live" },
      { label: "Repo", url: "https://github.com/joshuaparris-max/JoshHealth", type: "repo" },
    ],
    localPath: "C:/JoshHealth",
    notes: "Health tracking application.",
    lastTouched: "2026-05",
    metadataConfidence: "verified",
    availability: "hybrid",
  },
  ...
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["research", "memory", "utility"],
    primaryUrl: "",
    urls: [],
    localPath: "C:/ResearchMemory",
    notes: "Research and memory management tool.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "local",
  },
  {
    id: "parris-tech-app",
    name: "Parris Tech App",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["tech", "parris"],
    primaryUrl: "https://parris-tech-app.vercel.app/",
    liveUrl: "https://parris-tech-app.vercel.app/",
    urls: [{ label: "Live", url: "https://parris-tech-app.vercel.app/", type: "live" }],
    metadataConfidence: "verified",
    availability: "web",
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["avance", "professional-development"],
  ...
  },
  {
    ...
    status: "ok",
    tags: ["notes", "field"],
    primaryUrl: "https://field-notes-two.vercel.app/",
    liveUrl: "https://field-notes-two.vercel.app/",
    urls: [{ label: "Live", url: "https://field-notes-two.vercel.app/", type: "live" }],
    metadataConfidence: "verified",
    availability: "web",
  },
  {
    id: "parris-tech-services",
    name: "Parris Tech Services App",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["tech", "services"],
    primaryUrl: "https://parris-tech-services-app.vercel.app/",
    liveUrl: "https://parris-tech-services-app.vercel.app/",
    urls: [{ label: "Live", url: "https://parris-tech-services-app.vercel.app/", type: "live" }],
    metadataConfidence: "verified",
    availability: "web",
  },
  {
  ...
  {
    id: "sylvie-sleepytime",
    name: "Sylvie Sleepytime",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["sylvie", "sleepy", "github-pages"],
    primaryUrl: "https://joshualparris.github.io/Sleepy/",
    liveUrl: "https://joshualparris.github.io/Sleepy/",
    urls: [{ label: "Live", url: "https://joshualparris.github.io/Sleepy/", type: "live" }],
    metadataConfidence: "verified",
    availability: "web",
  },
  {
    id: "sylvie-phonics",
    name: "Sylvie Phonics App",
    type: "app",
    category: "Apps",
    status: "ok",
  ...
  },
  {
    ...
    status: "ok",
    tags: ["sylvie", "vercel"],
    primaryUrl: "https://sylvie-app-five.vercel.app/",
    liveUrl: "https://sylvie-app-five.vercel.app/",
    urls: [{ label: "Live", url: "https://sylvie-app-five.vercel.app/", type: "live" }],
    metadataConfidence: "verified",
    availability: "web",
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["hermes", "control", "automation", "wsl", "discord"],
    primaryUrl: "",
    urls: [],
    localPath: "C:/HermesControl",
    notes: "Suite of tools for Hermes control, WSL runner, and Discord troubleshooting.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "local",
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["performance", "tuneup", "windows", "cleanup", "chrome"],
    primaryUrl: "",
    urls: [],
    localPath: "C:/PerformanceTuneup",
    notes: "Collection of PowerShell scripts for Windows and Chrome performance optimization.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "local",
  },
  {
    id: "realms-atlas-v1",
    name: "Realms Atlas v1",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["atlas", "map", "vercel", "github-pages"],
    primaryUrl: "https://realms-atlas-readable-map-patch.vercel.app/",
    urls: [
      { label: "Vercel", url: "https://realms-atlas-readable-map-patch.vercel.app/" },
      { label: "GitHub Pages", url: "https://joshuaparris-max.github.io/realms-atlas/" },
    ],
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
  ...
  {
    id: "kkc-adventure",
    name: "King Killer Chronicle Adventure",
    type: "game",
    category: "Games",
    status: "ok",
  ...
  },
  {
    ...
    category: "Apps",
    status: "ok",
    tags: ["power", "app", "vercel", "github-pages"],
  ...
  {
    id: "rothfuss-maps",
    name: "Rothfuss - University Maps",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["maps", "rothfuss", "university", "github-pages"],
    primaryUrl: "https://joshualparris.github.io/RothfussMaps/university-atlas/",
    urls: [
      { label: "Live", url: "https://joshualparris.github.io/RothfussMaps/university-atlas/" },
    ],
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
  ...
  {
    id: "neverwinter-rpg-v2",
    name: "Neverwinter RPG",
    type: "game",
    category: "Games",
    status: "ok",
    tags: ["game", "neverwinter", "vercel"],
    primaryUrl: "https://skill-deploy-dwxq7kw5pa.vercel.app/",
    urls: [
      { label: "Vercel 1", url: "https://skill-deploy-dwxq7kw5pa.vercel.app/" },
      { label: "Vercel 2", url: "https://skill-deploy-wbzruert4j-codex-agent-deploys.vercel.app" },
    ],
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
  },
  {
    ...
    category: "Games",
    status: "ok",
    tags: ["game", "forbidden-lands", "lite", "vercel"],
    primaryUrl: "https://skill-deploy-7tfaq44eli-codex-agent-deploys.vercel.app",
    urls: [
      { label: "Live", url: "https://skill-deploy-7tfaq44eli-codex-agent-deploys.vercel.app" },
    ],
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
  ...
  },
  {
    ...
    category: "Games",
    status: "ok",
    tags: ["game", "ashfaller", "github-pages"],
    primaryUrl: "https://joshualparris.github.io/ashfaller/",
    urls: [
      { label: "v1", url: "https://joshualparris.github.io/ashfaller/" },
      { label: "v2", url: "https://joshualparris.github.io/AshFallen/" },
    ],
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
