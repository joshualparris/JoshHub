...
export const apps: CatalogItem[] = [
  ...
  },
  {
    ...
    primaryUrl: "file:///C:/Users/jparris@ltu.edu.au/OneDrive%20-%20LA%20TROBE%20UNIVERSITY/Desktop/Projects/HugCoach",
    urls: [
      {
        label: "Local folder",
        url: "file:///C:/Users/jparris@ltu.edu.au/OneDrive%20-%20LA%20TROBE%20UNIVERSITY/Desktop/Projects/HugCoach",
      },
    ...
    notes: "Local Next.js app. To run locally: open a terminal, `cd Projects/HugCoach`, then `npm install` and `npm run dev`. To add a Play link, build or copy a static export into JoshHub's `public/games/hugcoach/`.",
    nextAction: "Mirror built site into /public/games/hugcoach or publish to Vercel and update primaryUrl.",
    lastTouched: "2025-12",
  },
];
