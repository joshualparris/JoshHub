...
export const apps: CatalogItem[] = [
  ...
  },
  {
    ...
    primaryUrl: "",
    urls: [{ label: "Status (unavailable)", url: "" }],
    notes: "Local workspace path and status page are currently unavailable.",
    lastTouched: "2026-06",
    availability: "local",
    metadataConfidence: "verified",
  },
  ...
  {
    id: "research-gecare2",
    name: "Research Gecare2",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["research", "gecare2", "github-pages"],
    primaryUrl: "https://joshualparris.github.io/ResearchGecare2/",
    liveUrl: "https://joshualparris.github.io/ResearchGecare2/",
    urls: [
      { label: "Live", url: "https://joshualparris.github.io/ResearchGecare2/", type: "live" },
    ],
    notes: "Research gecare2 management tool.",
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
  },
  ...
  {
    id: "realcare2-atlas-v1",
    name: "Realcare2 Atlas v1",
    type: "app",
    category: "Apps",
    status: "ok",
    tags: ["atlas", "map", "vercel", "github-pages"],
    primaryUrl: "https://realcare2-atlas-readable-map-patch.vercel.app/",
    urls: [
      { label: "Vercel", url: "https://realcare2-atlas-readable-map-patch.vercel.app/" },
      { label: "GitHub Pages", url: "https://joshuaparris-max.github.io/realcare2-atlas/" },
    ],
    lastTouched: "2026-06",
    metadataConfidence: "verified",
    availability: "web",
  ...
  {
    id: "realcare2-atlas-v2",
    name: "Realcare2 Atlas v2",
    type: "game",
    category: "Games",
    status: "ok",
    tags: ["game", "atlas", "map", "github-pages"],
    primaryUrl: "https://joshualparris.github.io/realcare2-atlas/",
    urls: [
      { label: "Live", url: "https://joshualparris.github.io/realcare2-atlas/" },
    ],
