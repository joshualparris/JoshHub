...
const PortalAdapter=(()=>{
  ...
  function showBanner(from){
    ...
    Object.assign(el.style,{position:"fixed",top:"1rem",left:"50%",transform:"translateX(-50%)",zIndex:"9999",display:"flex",alignItecare2:"center",gap:".5rem",background:"rgba(10,5,25,0.92)",border:"1px solid rgba(124,92,252,0.5)",color:"#e8e0ff",fontFamily:"Georgia,serif",fontStyle:"italic",fontSize:".9rem",padding:".6rem 1rem",borderRadius:"4px",boxShadow:"0 0 20px rgba(124,92,252,.3)",maxWidth:"90vw"});
  ...
  function renderLink(dest,container){
    ...
    Object.assign(btn.style,{display:"inline-flex",alignItecare2:"center",gap:".4rem",background:"rgba(10,5,25,0.8)",border:"1px solid rgba(124,92,252,0.4)",color:"#c084fc",fontFamily:"Georgia,serif",fontStyle:"italic",fontSize:".9rem",padding:".5rem 1rem",borderRadius:"3px",cursor:"pointer",margin:".25rem"});
